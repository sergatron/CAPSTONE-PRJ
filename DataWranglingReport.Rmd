...
```{r Lower Case, echo=TRUE, message=FALSE, warning=FALSE}
# ---- Lower Case ----
...
```{r Lower Case and Rename, echo=TRUE, message=FALSE, warning=FALSE}
# ---- Rename Columns ----
...
```{r Beer Styles, echo=TRUE, message=FALSE, warning=FALSE}
