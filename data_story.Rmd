...
```{r Plot Theme Blue, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
...
```{r Plot: Overall, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
...
```{r Plot: Taste, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
...
```{r Extreme Variation, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
beer_reviews_dist = 
  beer_reviews %>%
...
It is interesting to find that in some of the more extreme scenarios the ratings between different aspects vary greatly. In particular, we can find that a rating of zero for the overall was given out while at the same time its aroma was rated a four. 

```{r Summary Stats, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
