...
```{r Filter: 5 Deviations, echo=TRUE, message=FALSE, warning=FALSE}
# NOTE: 
...
```{r ABV Plot, message=FALSE, warning=FALSE}
...
```{r Profile Names, echo=TRUE, message=FALSE, warning=FALSE}
...
beer_reviews_1 = 
  ...
  select(taste, aroma, appearance, overall, palate,beer_abv, ovr_grade, beer_name_cnt, brewery_name_cnt,
         profile_name_cnt,beer_id,brewery_id,beer_name, brewery_name, beer_abv_factor, beer_style, general_beer_style) 
...
```{r WSS plot, echo=FALSE, message=FALSE, warning=FALSE}
# ---- SCALE ---- 
